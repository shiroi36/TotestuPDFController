 ...
 * @author keita
 */
public class TotetsuPDFController2 {
...
//        System.out.println("Witdhサイズ = " + rec.getWidth());
        Logger log = LogManager.getLogger(TotetsuPDFController2.class);
...
//                    System.out.println(fs[j].getName());
                try {
                    ...
                    TotetsuPDFController2 tpc = new TotetsuPDFController2(fs[j].getAbsolutePath());
                    String[][] val = tpc.getCoilInfo();
                    log.info(fs[j].getName());
//                    log.debug(fs[j].getName());
//                System.out.println("CertificateNo = " + tpc.getKeiyakuNo());
                    String date0 = tpc.getDate();
//                    System.out.println(date0);
                    SimpleDateFormat sdFormat = new SimpleDateFormat("yyyy/MM/dd");
                    Date date2 = sdFormat.parse(date0);
                    //フォーマットパターンを指定して表示する
...
//                        xls.writeString(7, v[2]);
                        xls.writeDoubleSeparate(7, Double.parseDouble(v[2]));
...
//        
    ...
    public TotetsuPDFController2(String path) throws IOException {
